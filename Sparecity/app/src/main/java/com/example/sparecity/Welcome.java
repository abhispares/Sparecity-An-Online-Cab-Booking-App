...
public class Welcome extends FragmentActivity implements OnMapReadyCallback {
    ...
    private float getBearing(LatLng startPosition, LatLng endPosition) {
        ...
        if (startPosition.latitude < endPosition.latitude && startPosition.longitude < endPosition.longitude)
            ...
            return (float) (90 - (Math.toDegrees(Math.atan(lng / lat))) + 2700);
        return -1;
    }
...
//        });
        if(!Places.isInitialized()){
            Places.initialize(getApplicationContext(),"AIzaSyBSLW315PzqsLvAft0RPQ633IF0Za3QfiE");
        }

        places = (AutocompleteSupportFragment) getSupportFragmentManager().findFragmentById(R.id.place_autcomplete_fragment);
        ...
        FirebaseInstanceId.getInstance()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Welcome.this,""+e.getMessage(),Toast.LENGTH_SHORT);
                    }
                })
